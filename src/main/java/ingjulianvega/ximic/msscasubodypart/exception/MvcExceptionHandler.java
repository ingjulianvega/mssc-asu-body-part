...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    BodyPartParameters bodyPartParameters;

    public MvcExceptionHandler(BodyPartParameters bodyPartParameters) {
        this.bodyPartParameters = bodyPartParameters;
    }

    @ExceptionHandler(BodyPartException.class)
    public ResponseEntity<ApiError> validationErrorHandler(BodyPartException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(bodyPartParameters.getApi())
