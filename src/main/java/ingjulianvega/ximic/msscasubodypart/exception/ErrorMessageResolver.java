...
public class ErrorMessageResolver {
    ...
    private final BodyPartParameters bodyPartParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(bodyPartParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(bodyPartParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
